                        ...
                        <div className="space-y-6 px-4 py-6">
                            {navigation.pages.map((page) => (
                                <div key={page.name} className="flow-root">
                                    {/* Cambiado a Link para navegación fluida en móvil */}
                                    <Link 
                                        to={page.href} 
                                        className="-m-2 block p-2 font-medium text-gray-900 dark:text-gray-200" 
                ...
                <nav aria-label="Top" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <div className="flex lg:ml-0 items-center gap-2">
                            <Link to="/#nav" className="flex items-center gap-2">
                        ...
                        {/* Enlaces Centrales (Desktop) - SIMPLIFICADO */}
